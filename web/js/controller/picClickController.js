 ...
 */
app.controller('picClickController', function($scope, $location, appService, products,
        $routeParams, util, iframeService) {
        ...
        addListenToInnder: function() {
            ...
            crossDomainOuter.onInnerWindowLoaded = function(conf) {
                ...
                _pri.fetchDataAndRender({
                    ...
                    recent: pinfo.defaults.recent_click,
                    pid: pinfo.pid
                });
            };
